...
if(isset($_GET['page'])){
    $page = $_GET['page'];
        ...
        $bo_mq = mq("select * from board where category = 'print'");
        ...
        $start_num = ($page-1) * $list; //시작번호 (page-1)에서 $list를 곱한다.
            ...
            $sql = mq("select * from board where category = 'print' order by view desc limit $start_num, $list");  
              while($board = $sql->fetch_array()){
                  $img= $board['file'];
                    echo "<div class='img_list'>
                    <a href = 'portfolio.php?page2=print&img9=$img'>
                    <img src='../upload/$img'/>
                    </a>
                    </div>";
              }
