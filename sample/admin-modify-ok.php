...
$sql = mq("update board set name='".$username."',title='".$title."',content='".$content."',file='".$file_Name."',category='".$check."' where idx='".$bno."'"); ?>

<script type="text/javascript">alert("글쓰기 완료되었습니다.");</script>
<meta http-equiv="refresh" content="0 url=/example/sample/admin-sl.php" />